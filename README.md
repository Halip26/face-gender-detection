...
## Completed codes & comments of images-gender-detect.py
...
def predict_gender(input_path: str):
    ...
    for i, (start_x, start_y, end_x, end_y) in enumerate(faces):
        ...
        box_color = (0, 128, 0) if gender == "Male" else (255, 20, 147)
    ...
    display_img("Prediksi Gender v1.0", frame)
    # uncomment if you want to save the image
    cv2.imwrite("output_gender.jpg", frame)
    # Cleanup
    cv2.destroyAllWindows()
...
## Completed codes & comments of live-gender-detect.py
